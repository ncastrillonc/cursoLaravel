<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="http://www.mmaspain.com/wp-content/uploads/2015/01/Facebook_logo.png" width="100" height="20"></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-left" role="search">
        <div class="form-group">
          <input type="text" data-provide="typeahead" data-source='[{$friends}]' class="form-control" placeholder="Buscar personas, lugares" class="input-md">
        </div>
      </form>
